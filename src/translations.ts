...
export const TRANSLATIONS: Record<LanguageCode, TranslationSet> = {
  en: {
    ...
    heroCtaPrimary: "Explore Projects Portfolio",
    ...
    footerSpace: "Budi Prst AI-DX Solutions.",
  ...
  ja: {
    ...
    heroCtaPrimary: "プロジェクト実績ポートフォリオを見る",
    ...
    footerSpace: "Budi Prst AI-DX ソリューションズ",
  ...
  fr: {
    ...
    heroCtaPrimary: "Explorer le Portfolio de Projets",
    ...
    galleryTitle: "Portfolio de Projets",
    ...
    footerSpace: "Budi Prst Solutions IA-DX.",
  ...
  es: {
    ...
    heroCtaPrimary: "Explorar Portafolio de Proyectos",
    ...
    galleryTitle: "Portafolio de Proyectos",
    ...
    footerSpace: "Budi Prst Soluciones de IA-DX.",
  ...
  de: {
    ...
    heroCtaPrimary: "Projekt-Portfolio ansehen",
    ...
    galleryTitle: "Projekt-Portfolio",
    ...
    footerSpace: "Budi Prst AI-DX-Lösungen.",
  ...
  id: {
    ...
    heroCtaPrimary: "Pelajari Portofolio Proyek",
    ...
    galleryTitle: "Portofolio Proyek",
    ...
    footerSpace: "Budi Prst Solusi AI-DX.",
  ...
  sw: {
    ...
    heroCtaPrimary: "Chunguza Portofolio ya Miradi",
    ...
    galleryTitle: "Portofolio ya Miradi",
    ...
    footerSpace: "Suluhisho za AI-DX za Budi Prst.",
  ...
  yo: {
    ...
    heroCtaPrimary: "Wo Àwọn Iṣẹ wa (Portfolio)",
    ...
    galleryTitle: "Àwọn Iṣẹ wa (Portfolio)",
    ...
    footerSpace: "Àwọn Ojútùú AI-DX ti Budi Prst.",
  ...
  zu: {
    ...
    heroCtaPrimary: "Hlola I-Portfolio Yemisebenzi",
    ...
    galleryTitle: "I-Portfolio Yemisebenzi",
    ...
    footerSpace: "Izixazululo Ze-AI-DX Zikabudi Prst.",
